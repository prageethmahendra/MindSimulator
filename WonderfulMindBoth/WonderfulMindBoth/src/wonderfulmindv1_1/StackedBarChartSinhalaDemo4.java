 ...
 */
public class StackedBarChartSinhalaDemo4 extends ApplicationFrame {
     ...
     */
    public StackedBarChartSinhalaDemo4(final String title) {
        super(title);
    ...
    public static JFreeChart createChart(final CategoryDataset dataset, ArrayList<String> orangeArray, boolean isDefault) {
        ...
        final JFreeChart chart = ChartFactory.createStackedBarChart(
                "          තෝරනුලැබූ චෛතසික", // chart title
                "Category", // domain axis label
                "චෛතසික ගණන", // range axis label
                dataset, // data
        ...
        Font font3 = new Font("Iskoola Pota", Font.BOLD, 18);
        ...
        Font font4 = new Font("Iskoola Pota", Font.BOLD, 20);
